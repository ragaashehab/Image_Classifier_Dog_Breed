...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        lower_classifier_label= classifier_label.lower()
        model_label= lower_classifier_label.strip()
...
"""
    for key in results_dic.keys():
        ...
        test_image= images_dir +"/"+ key
        classifier_label = classifier(test_image, model)
        rsltlist = results_dic[key]
        #print(rsltlist)
        lower_classifier_label = classifier_label.lower()
        rsltlist.append(lower_classifier_label)
        if rsltlist[0] in rsltlist[1]:
